...
RESEARCH_MAX_EVIDENCE_RECORDS = 36
RESEARCH_MAX_FINANCIAL_OBSERVATIONS = 28
RESEARCH_MAX_COMMENTARY_OBSERVATIONS = 14
RESEARCH_MAX_DISCLOSURES = 6
RESEARCH_MAX_BUSINESS_DRIVERS = 4
RESEARCH_MAX_COMMITMENTS = 6
RESEARCH_MAX_MANAGEMENT_THEMES = 3
